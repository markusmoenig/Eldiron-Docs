...
The next release of Eldiron, expected from early to mid-December, will include new features and major UI changes. The current documentation is already outdated. I will update the documentation and create new videos as soon as the new version is released.
</Admonition>
