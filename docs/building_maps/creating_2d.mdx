...
We can do this with the [Edit Tile Meta](/docs/creator/actions/#edit-tile-meta) tool, select **Yes / No** for the *Blocking* state (default is not blocking). Dont forget to click **Apply** if you do not have the **Automatic** mode turned on.
